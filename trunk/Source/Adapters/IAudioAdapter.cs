...
{
    public interface IAudioAdapter : IOAuth2
    {
        /// <summary>
        ...
        IEnumerable<AudioTrack> GetItems(string setName, OAuthAccessToken accessToken);
        ...
        /// <returns>A list of urls of audio.</returns>
        IEnumerable<AudioTrack> GetItems(string setName, OAuthAccessToken accessToken, int page, int pageSize);
        ...
        AudioTrack GetItem(int id, OAuthAccessToken accessToken);
