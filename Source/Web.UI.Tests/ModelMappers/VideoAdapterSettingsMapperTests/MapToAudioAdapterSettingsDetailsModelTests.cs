...
{
    [TestClass]
    public class MapToVideoAdapterSettingsDetailsModelTests : VideoAdapterSettingsMapperTestBase
    {
        [TestMethod]
        public void When_VideoAdapterSettings_is_mapped_to_a_VideoAdapterSettingsDetailsModel_then_all_data_is_mapped_correct()
        {
        ...
        [TestMethod]
        public void When_VideoAdapterSettings_is_mapped_to_a_VideoAdapterSettingsDetailsModel_and_the_ApiKey_is_null_then_the_result_ApiKey_is_null()
        {
            var entity = AdapterSettingsCreator.CreateSingle();
            entity.SetName = null;
